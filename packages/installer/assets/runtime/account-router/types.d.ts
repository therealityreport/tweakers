...
export declare const ACCOUNT_ROUTER_SCHEMA_VERSION_V3: 3;
 ...
 */
export declare const ACCOUNTS_BROKER_VERSION: 1;
/** Hard configuration bound; the resident target is every enabled subscription. */
export declare const ACCOUNTS_BROKER_MAX_RESIDENT_CHILDREN: 64;
export declare const ACCOUNTS_BROKER_MAX_CHILD_START_CONCURRENCY: 4;
/** Desktop renderer sessions are bounded independently from child residency. */
export declare const ACCOUNTS_BROKER_MAX_CLIENTS: 16;
export declare const ACCOUNTS_BROKER_IDLE_EVICTION_MS: 300000;
export declare const ACCOUNTS_BROKER_HANDOFF_TTL_MS: 60000;
...
export type BrokerEventPayloadV1 = AccountPoolV3 | QuotaProjectionV3[] | QuotaProjectionV3 | AccountPoolAccountV3 | BrokerEnrollmentV1 | ConnectionStateV3[] | TaskOwnershipV3 | PendingHandoffV1 | LogicalConversationProjectionV1 | LogicalTurnProjectionV1 | LogicalContinuationProjectionV1 | {
...
export type BrokerCommandV1 = BrokerRemoteCommandV1 | "enrollment.start" | "enrollment.status" | "enrollment.cancel" | "reconnect.start" | "reconnect.status" | "reconnect.cancel" | "profile.email" | "profile.statistics" | "profile.read" | "history.read" | "profile.update" | "enabled.set" | "quota.read" | "native.request" | "preferences.read" | "preferences.update" | "balance.read" | "balance.set" | "connection.list" | "connection.status" | "connection.authorize" | "resetCredit.consume" | "handoff.confirm" | "handoff.cancel" | "events.subscribe" | "events.unsubscribe";
...
export type BrokerErrorCode = "invalid_request" | "incompatible_client" | "unauthenticated" | "request_replayed" | "account_history_busy" | "account_unavailable" | "capacity_held" | "task_unavailable" | "handoff_unavailable" | "handoff_active" | "handoff_expired" | "handoff_ambiguous" | "linked_continuation_required" | "provider_confirmation_required" | "broker_setup_required" | "broker_unavailable";
...
export declare function isOpaqueRendererRef(value: unknown): value is OpaqueRendererRef;
export declare function isOpaqueAppToolsRef(value: unknown): value is OpaqueAppToolsRef;
export declare function isOpaqueTaskRef(value: unknown): value is OpaqueTaskRef;
export declare function isOpaqueHandoffRef(value: unknown): value is OpaqueHandoffRef;
export declare function isOpaqueConversationId(value: unknown): value is OpaqueConversationId;
export declare function isOpaqueSegmentId(value: unknown): value is OpaqueSegmentId;
export declare function isOpaqueTurnId(value: unknown): value is OpaqueTurnId;
export declare function isOpaqueConfirmationId(value: unknown): value is OpaqueConfirmationId;
export declare function isOpaqueConnectionDefinitionRef(value: unknown): value is OpaqueConnectionDefinitionRef;
export declare function isOpaqueEnrollmentRef(value: unknown): value is OpaqueEnrollmentRef;
