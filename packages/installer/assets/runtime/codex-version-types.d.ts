...
export type CodexFeatureStage = "stable" | "experimental" | "under-development" | "deprecated" | "removed";
...
export type CodexInstallPhase = "idle" | "resolving" | "downloading" | "verifying-digest" | "verifying-signature" | "extracting" | "probing" | "promoting" | "rolling-back" | "complete" | "failed";
...
export interface CodexVersionServiceDependencies {
    ...
    execFile: (binary: string, args: readonly string[], options: {
        timeoutMs: number;
...
export interface CodexVersionService {
    fetchLatestRelease(lane: CodexCliLane, options?: {
        force?: boolean;
