...
import {
  ...
  ENVIRONMENT_TRANSACTION_SCHEMA_VERSION,
  isTerminalEnvironmentPhase,
  preparedEvidenceMatches,
  ...
  type PreparedRollbackEvidence,
  type PreparedRuntimeArtifactEvidence,
  type PreparedRuntimeEvidence,
...
export class InstallerEnvironmentCoordinator implements EnvironmentCoordinator {
  ...
  private async cancelUnlocked(transactionId?: string): Promise<EnvironmentTransactionReceipt> {
    return cancelPreparedEnvironmentTransaction({
      transactionFile: this.transactionFile,
      receiptRoot: this.receiptRoot,
