...
- **Plan state:** **IN PROGRESS.** The status-only Tweakers provider, immutable descriptor publication, and Menu Bar host/adaptor milestone is complete at source/generated-artifact/build level. Live installation and every action family remain deferred; Program B is out of scope for this execution.
